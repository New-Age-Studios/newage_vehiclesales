  ...
  return (
    <div className="flex flex-col items-center text-center space-y-1 mb-4">
      ...
      <div className="flex flex-col">
        <span className="text-[10px] font-bold text-zinc-700 tracking-wider">CONTRATO DE COMPRA E VENDA DE VEÍCULO</span>
        <span className="text-[9px] text-zinc-500 font-medium tracking-tighter">Nº {data.id}</span>
      </div>
    </div>
  );
};
